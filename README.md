...
При использовании и распространении сохраняйте атрибуцию оригинальному репозиторию и соблюдайте условия лицензии MIT.
...
- .NET 9 SDK/Runtime
- Windows/Linux/macOS
- Права администратора/root (приложение проверяет это на старте и пытается перезапуститься с повышением прав)
